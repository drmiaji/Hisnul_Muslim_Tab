...
import com.drmiaji.hisnulmuslimtab.adapter.DuaAdapter
    ...
    private fun setupRecyclerView() {
        ...
        adapter = DuaAdapter(emptyList()) { duaName ->
            ...
            lifecycleScope.launch {
                ...
                if (firstDetail != null) {
                    val intent = Intent(this@ChapterListActivity, com.drmiaji.hisnulmuslimtab.ui.WebViewActivity::class.java).apply {
